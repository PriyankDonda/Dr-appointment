...
import ADAUpdate from './ADAUpdate'
                      ...
                      filter.map((ap) => (
                        <tr key={ap._id}>
                          ...
                          <td><div>
                            ...
                            {currentAppointment._id === ap._id ? <ADAUpdate data={currentAppointment} onClose={changeCurrentAppointment} updateDashboard={checklogedin}/> : null}
